...
1. Descriptive Analytics
   ...
   It focuses on analyzing historical data to identify trends, patterns and summaries.

   Businesses commonly use it for reporting and tracking performance, as it gives an overview of results over time.
...
2. Diagnostic Analytics
   ...
   It goes deeper than descriptive analytics by examining data to find patterns, dependencies and causes.

   This type of analysis helps organizations uncover the reasons behind success or failure.
